...
// Factory returns a provider.Factory for creating Cloudflare provider instances.
// This is the recommended way to register the Cloudflare provider with the registry.
